 ...
 *
 * 実行方法(リポジトリルートから):
 *   node agent-skills/irodori/runs/2026-07-16-cybex-libelle-2026-official/validate-run.mjs
 */
...
check(
  ...
  identity.model_number === null
    ...
    && identity.variants[0].product_code === "526001009"
...
check(
  ...
  identity.site_product_id === "7" && identity.site_product_match_status === "probable",
);
check(
...
check(
  ...
  Boolean(manual)
    ...
    && manual.discovery_page_url === "https://download.cybex-online.com/products/libelle-2026"
...
check(
  "2025年モデルの仕様が混入していない",
  sources.every((s) => s.url !== "https://www.cybex-online.com/en/jp/p/st-go-libelle-5.html"),
);
